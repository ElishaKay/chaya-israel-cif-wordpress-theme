...
// pushing donation id and value to Google Tag Manager

function financial(x) {
  return Number.parseFloat(x).toFixed(2);
}

var donationValue = "<?php echo give_payment_amount( $payment->ID ); ?>";
donationValue.split("$");

dataLayer.push({
    'donationId': "<?php echo give_get_payment_number( $payment->ID ); ?>",
    'donationValue':  financial(donationValue[1])
});

var globalDonationValue = financial(donationValue[1]);
