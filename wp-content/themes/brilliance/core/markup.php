...
if(!function_exists('cpotheme_footer')){
	function cpotheme_footer(){		
		...
		echo '<p>The Chaya Israel Israel Foundation is a 501(c)(3) Charitable Organization. Any donations are tax deductible to US citizens. All donations are tax deductible to US Citizens. You will get an immediate email with a Tax Exempt Donation Receipt. Thanks for everything 🙏</p>'; 
		echo '</div>';
	}
}
